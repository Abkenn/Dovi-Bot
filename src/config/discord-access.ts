...
export const COMMAND_GUILDS = {
  ...
  TRACK_BOSS_START: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_DEATH: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_PAUSE: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_RESUME: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_END: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_STATUS: [BOT_GUILDS.STAGING_ENV],
  TRACK_BOSS_CANCEL: [BOT_GUILDS.STAGING_ENV],
  UPDATE_BOSS_INFO: [BOT_GUILDS.STAGING_ENV],
  UPDATE_GAME_INFO: [BOT_GUILDS.STAGING_ENV],
