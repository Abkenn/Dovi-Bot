...
export const COMMAND_GUILDS = {
  ...
  STREAM_REMIND_ME: [BOT_GUILDS.STAGING_ENV, ...maybeProdEnvGuild],
  ...
  CHANGE_SCHEDULE: [BOT_GUILDS.STAGING_ENV, ...maybeProdEnvGuild],
  ...
  DAVI_CHANGE_SCHEDULE: [BOT_GUILDS.STAGING_ENV],
  DAVI_STREAM_INFO: [BOT_GUILDS.STAGING_ENV],
  DAVI_SAY: [BOT_GUILDS.STAGING_ENV],
