...
export const COMMAND_METADATA = {
  ...
  POLL_HOST: {
    name: 'poll-host',
    description: 'Opens nominations for a poll tournament.',
    guildIds: COMMAND_GUILDS.POLL_HOST,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.POLL_TOURNAMENTS,
  },
  POLL_NOMINATE: {
    name: 'poll-nominate',
    description: 'Privately nominates options for an open poll.',
    guildIds: COMMAND_GUILDS.POLL_NOMINATE,
    access: COMMAND_ACCESSES.DEFAULT,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.POLL_TOURNAMENTS,
  },
  POLL_START: {
    name: 'poll-start',
    description: 'Starts a poll tournament you hosted.',
    guildIds: COMMAND_GUILDS.POLL_START,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.POLL_TOURNAMENTS,
  },
  POLL_STATUS: {
    name: 'poll-status',
    description: 'Shows your active hosted polls privately in DMs.',
    guildIds: COMMAND_GUILDS.POLL_STATUS,
    access: COMMAND_ACCESSES.DEFAULT,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.POLL_TOURNAMENTS,
  },
  POLL_MANAGE: {
    name: 'poll-manage',
    description: 'Manages poll data privately in DMs for a poll you hosted.',
    guildIds: COMMAND_GUILDS.POLL_MANAGE,
    access: COMMAND_ACCESSES.DEFAULT,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.POLL_TOURNAMENTS,
  },
  ...
  STREAM_REMIND_ME: {
    ...
    description: 'Turns your reminders for all future streams on or off.',
    guildIds: COMMAND_GUILDS.STREAM_REMIND_ME,
    access: COMMAND_ACCESSES.DEFAULT,
    helpAudience: HELP_AUDIENCES.PUBLIC,
    helpCategory: COMMAND_CATEGORIES.STREAM_INFO,
  },
  ...
  CHANGE_SCHEDULE: {
    name: 'changeschedule',
    description: 'Changes a Friday or Saturday stream between game and music.',
    guildIds: COMMAND_GUILDS.CHANGE_SCHEDULE,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.ADMIN,
    helpCategory: COMMAND_CATEGORIES.STREAM_INFO,
  },
  ...
  STAGING_ANNOUNCE: {
    ...
    description: 'Posts a test stream upload announcement in staging.',
    guildIds: COMMAND_GUILDS.STAGING_ANNOUNCE,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.ADMIN,
    helpCategory: COMMAND_CATEGORIES.STAGING,
  },
  DAVI_UPDATE_ANNOUNCEMENT: {
    ...
    guildIds: COMMAND_GUILDS.DAVI_UPDATE_ANNOUNCEMENT,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.ADMIN,
    helpCategory: COMMAND_CATEGORIES.STAGING,
  },
  ...
  DAVI_CHANGE_SCHEDULE: {
    ...
    description: 'Changes a prod Friday or Saturday stream type.',
    guildIds: COMMAND_GUILDS.DAVI_CHANGE_SCHEDULE,
    access: COMMAND_ACCESSES.REGULAR,
    helpAudience: HELP_AUDIENCES.ADMIN,
    helpCategory: COMMAND_CATEGORIES.STAGING,
  },
