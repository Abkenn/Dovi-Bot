...
const METADATA = COMMAND_METADATA.DAVI_CHANGE_SCHEDULE;

export class DaviChangeScheduleCommand extends Command {
      ...
      (builder) =>
        builder
          ...
          .addStringOption((option) =>
            option
              .setName('day')
              .setDescription('Scheduled prod stream day')
              .setRequired(true)
              .addChoices(
  ...
  public override chatInputRun(
    ...
    return runCommand({
      ...
      run: async ({ editReply }) => {
        const guildId = BOT_GUILDS.PROD_ENV;
        ...
        return editReply({
          content: 'Prod env schedule updated.',
